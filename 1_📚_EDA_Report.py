...
I hope it taught you just as much as it has taught me. If you'd like to connect with me, my
links are provided below. Thank you for your time!
"""
)

# 5. Author Info.
st.markdown("## 5. Author Info")

st.markdown(
"""
- [GitHub Repo](https://github.com/alckasoc/Joblisting-Cleaning-EDA)
